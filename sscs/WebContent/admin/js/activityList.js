...
$().ready(function() {
	...
	$("#activityList", parent.document).parent().addClass("active");
	$("#activityList", parent.document).parent().parent().parent().addClass("active");
	$("#activityList", parent.document).parent().parent().parent().parent().parent().addClass("active");
